...
oneline_description: 'A new study from SmartX Lab introduces Reg2RG, a region-aware large language model framework for interpretable and fine-grained CT report generation, accepted by IEEE Transactions on Medical Imaging.'  
