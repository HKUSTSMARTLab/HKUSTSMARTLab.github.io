...
oneline_description: 'SmartX Lab is proud to announce the publication of our latest work, a generalizable pathology foundation model (GPFM) that is now published in Nature Biomedical Engineering.'
...
For more details, please see our paper [A generalizable pathology foundation model using a unified knowledge distillation pretraining framework](https://www.nature.com/articles/s41551-025-01488-4) via Nature Biomedical Engineering.

**Code \|** [https://github.com/birkhoffkiki/GPFM](https://github.com/birkhoffkiki/GPFM)

**Model weights \|** [Hugging Face](https://huggingface.co/majiabo/GPFM) · [GitHub release](https://github.com/birkhoffkiki/GPFM/releases/tag/ckpt)

**PathBench benchmark \|** [https://birkhoffkiki.github.io/PathBench/](https://birkhoffkiki.github.io/PathBench/)

**Preprint \|** [https://arxiv.org/abs/2407.18449](https://arxiv.org/abs/2407.18449)
