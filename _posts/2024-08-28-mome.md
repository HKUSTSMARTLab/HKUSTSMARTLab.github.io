...
For more details, please refer to the [original paper](https://www.nature.com/articles/s41467-025-58798-z) or [contact SmartX Lab](mailto:luyang.luo.xc@gmail.com). You may also find more information about Dr.Luo's research on [his homepage](https://llyxc.github.io/).

The [source code](https://github.com/LLYXC/MOME), [model weights](https://drive.google.com/drive/folders/1gfKWcEb-z-lCp_j7Jw9OizWmiW9rdziK?usp=drive_link), and [sample data](https://drive.google.com/drive/folders/1ja5OQJZCkDkTBMZorNt-hq1gVDH2dKWa?usp=sharing) are publicly available. The official code snapshot is preserved in the [MOME release](https://github.com/LLYXC/MOME/releases/tag/MOME).
