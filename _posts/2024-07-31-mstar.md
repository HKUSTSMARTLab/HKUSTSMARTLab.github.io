...
The [source code](https://github.com/Innse/mSTAR) is publicly available. Trained [model weights](https://huggingface.co/Wangyh/mSTAR) are available on request through Hugging Face, and the study version is archived on [Zenodo](https://doi.org/10.5281/zenodo.17273573).
