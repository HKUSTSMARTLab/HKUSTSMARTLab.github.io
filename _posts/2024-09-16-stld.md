...
$$\mathcal{R}^{\text{SL}}(f_{\bm{\theta}}) = \sum_{\mathclap{ (\bm{x}_i,\bm{y}_i) \in (\mathcal{X}_l, \mathcal{Y}*l) }} \mathcal{L} (f*{\bm{\theta}}(\bm{x}_i), {\bm{y}_i})$$.
...
$$\mathcal{R}^{\text{SSL}}(f_{\bm{\theta}}) = \mathcal{R}^{\text{SL}}(f_{\bm{\theta}}) + \lambda \cdot \sum_{\mathclap{ \bm{x}_i \in \mathcal{X}*u }} \mathcal{G}(f*{\bm{\theta}}, \bm{x}_i)$$.
...
$$\mathcal{R}^{\text{SBST}}(f_{\bm{\theta}}) = \mathcal{R}^{\text{SL}}(f_{\bm{\theta}}) + \sum_{\mathclap{ (\bm{x}_i,\bm{y}_i) \in \mathcal{A} \subseteq (\mathcal{X}_u, \widehat{\mathcal{Y}}*u) }} \mathcal{L} (f*{\bm{\theta}}(\bm{x}_i), {\bm{y}_i})$$.
...
**$$\mathcal{R}^{\text{SFST}}(f_{\bm{\theta}}) = \mathcal{R}^{\text{SL}}(f_{\bm{\theta}}) + \lambda \cdot \sum_{\mathclap{ (\bm{x}_i,\bm{y}_i) \in (\mathcal{X}_u, \widehat{\mathcal{Y}}*u) }} \mathcal{G}(f*{\bm{\theta}}(\bm{x}_i), {\bm{y}_i})$$.
...
$$\bm{\theta}*{\text{pre}} = \arg \min*{\bm{\theta}} \sum_{\mathclap{ (\bm{x}_i,\bm{y}_i) \in (\mathcal{X}_u, \widehat{\mathcal{Y}}*u) }} \mathcal{L} (f*{\bm{\theta}}(\bm{x}_i), {\bm{y}_i})$$.
...
- **Heatmap Regression**
    ...
    $$\mathcal{L}^{\text{SR}}_{\text{map}}(f_{\bm{\theta}}(\bm{x}), \bm{y}, t) = \mathcal{L} (f_{\bm{\theta}}(\bm{x}), \phi(\bm{y}, t)) = \mathcal{L} (f_{\bm{\theta}}(\bm{x}), \bm{\mu}, \sigma_t)$$.
...
- **Coordinate Regression**
    ...
    $$\mathcal{L}_1(\hat{\bm{y}}, \bm{y}) = |\hat{\bm{y}} - \bm{y}| \quad \text{and} \quad \mathcal{L}_2(\hat{\bm{y}}, \bm{y}) = \frac{1}{2}(|\hat{\bm{y}} - \bm{y}|)^2$$.
    
    We further write the gradients of the two losses w.r.t. θ as
    
    $$\frac{\partial \mathcal{L}*1(\hat{\bm{y}}, \bm{y})}{\partial \bm{\theta}} = \pm 1 \cdot \nabla*{\bm{\theta}} \hat{\bm{y}}$$
    
    and
    
    $$\frac{\partial \mathcal{L}*2(\hat{\bm{y}}, \bm{y})}{\partial \bm{\theta}} = \pm |\hat{\bm{y}} - \bm{y}| \cdot \nabla*{\bm{\theta}} \hat{\bm{y}}$$.
    ...
    $$\mathcal{L}_{p}(\hat{\bm{y}}, \bm{y}) = \frac{1}{p}(|\hat{\bm{y}} - \bm{y}|)^{p}, \quad p \geq 1$$.
    ...
    $$\mathcal{L}^{\text{SR}}*{\text{coord}}(f*{\bm{\theta}}(\bm{x}), \bm{y}, t) = \mathcal{L}*{p_t} (f*{\bm{\theta}}(\bm{x}), \bm{y})$$.
