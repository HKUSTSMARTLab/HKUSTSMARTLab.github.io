...
$$
\mathcal{R}^{\text{SL}}(f_{\boldsymbol{\theta}}) = \sum_{\mathclap{ (\boldsymbol{x}_i,\boldsymbol{y}_i) \in (\mathcal{X}_l, \mathcal{Y}*l) }} \mathcal{L} (f*{\boldsymbol{\theta}}(\boldsymbol{x}_i), {\boldsymbol{y}_i})
$$
...
$$\mathcal{R}^{\text{SSL}}(f_{\boldsymbol{\theta}}) = \mathcal{R}^{\text{SL}}(f_{\boldsymbol{\theta}}) + \lambda \cdot \sum_{\mathclap{ \boldsymbol{x}_i \in \mathcal{X}*u }} \mathcal{G}(f*{\boldsymbol{\theta}}, \boldsymbol{x}_i)$$.
...
$$\mathcal{R}^{\text{SBST}}(f_{\boldsymbol{\theta}}) = \mathcal{R}^{\text{SL}}(f_{\boldsymbol{\theta}}) + \sum_{\mathclap{ (\boldsymbol{x}_i,\boldsymbol{y}_i) \in \mathcal{A} \subseteq (\mathcal{X}_u, \widehat{\mathcal{Y}}*u) }} \mathcal{L} (f*{\boldsymbol{\theta}}(\boldsymbol{x}_i), {\boldsymbol{y}_i})$$.
...
**$$\mathcal{R}^{\text{SFST}}(f_{\boldsymbol{\theta}}) = \mathcal{R}^{\text{SL}}(f_{\boldsymbol{\theta}}) + \lambda \cdot \sum_{\mathclap{ (\boldsymbol{x}_i,\boldsymbol{y}_i) \in (\mathcal{X}_u, \widehat{\mathcal{Y}}*u) }} \mathcal{G}(f*{\boldsymbol{\theta}}(\boldsymbol{x}_i), {\boldsymbol{y}_i})$$.
...
$$\boldsymbol{\theta}*{\text{pre}} = \arg \min*{\boldsymbol{\theta}} \sum_{\mathclap{ (\boldsymbol{x}_i,\boldsymbol{y}_i) \in (\mathcal{X}_u, \widehat{\mathcal{Y}}*u) }} \mathcal{L} (f*{\boldsymbol{\theta}}(\boldsymbol{x}_i), {\boldsymbol{y}_i})$$.
...
- **Heatmap Regression**
    ...
    $$\mathcal{L}^{\text{SR}}_{\text{map}}(f_{\boldsymbol{\theta}}(\boldsymbol{x}), \boldsymbol{y}, t) = \mathcal{L} (f_{\boldsymbol{\theta}}(\boldsymbol{x}), \phi(\boldsymbol{y}, t)) = \mathcal{L} (f_{\boldsymbol{\theta}}(\boldsymbol{x}), \boldsymbol{\mu}, \sigma_t)$$.
...
- **Coordinate Regression**
    ...
    $$\mathcal{L}_1(\hat{\boldsymbol{y}}, \boldsymbol{y}) = |\hat{\boldsymbol{y}} - \boldsymbol{y}| \quad \text{and} \quad \mathcal{L}_2(\hat{\boldsymbol{y}}, \boldsymbol{y}) = \frac{1}{2}(|\hat{\boldsymbol{y}} - \boldsymbol{y}|)^2$$.
    
    We further write the gradients of the two losses w.r.t. θ as
    
    $$\frac{\partial \mathcal{L}*1(\hat{\boldsymbol{y}}, \boldsymbol{y})}{\partial \boldsymbol{\theta}} = \pm 1 \cdot \nabla*{\boldsymbol{\theta}} \hat{\boldsymbol{y}}$$
    
    and
    
    $$\frac{\partial \mathcal{L}*2(\hat{\boldsymbol{y}}, \boldsymbol{y})}{\partial \boldsymbol{\theta}} = \pm |\hat{\boldsymbol{y}} - \boldsymbol{y}| \cdot \nabla*{\boldsymbol{\theta}} \hat{\boldsymbol{y}}$$.
    ...
    $$\mathcal{L}_{p}(\hat{\boldsymbol{y}}, \boldsymbol{y}) = \frac{1}{p}(|\hat{\boldsymbol{y}} - \boldsymbol{y}|)^{p}, \quad p \geq 1$$.
    ...
    $$\mathcal{L}^{\text{SR}}*{\text{coord}}(f*{\boldsymbol{\theta}}(\boldsymbol{x}), \boldsymbol{y}, t) = \mathcal{L}*{p_t} (f*{\boldsymbol{\theta}}(\boldsymbol{x}), \boldsymbol{y})$$.
