...
*Table 4: Comparison for fine-grained cervical cancer classification task, with the best results highlighted in bold.*
...
*Table 5: Evaluation of hierarchical guidance on model performance. \cmark denotes applying the corresponding module to the model. Best results are highlighted in bold.*
