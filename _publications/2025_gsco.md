...
github:
    - url: 'sunanhe/MedDr'
links:
    - name: 'GSCI Generalist Model Weights'
      url: 'https://huggingface.co/Sunanhe/MedDr_0401'
    - name: 'GSCo Specialist Model Weights'
      url: 'https://huggingface.co/Sunanhe/GSCo_Specialist'
    - name: 'Project Page'
      url: 'https://smart-meddr.github.io/'
    - name: 'Dataset Access Guide'
      url: 'https://github.com/sunanhe/MedDr/blob/main/DATASET.md'
---
